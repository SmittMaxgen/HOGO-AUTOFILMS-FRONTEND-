...
const useStyles = makeStyles(() => ({
  ...
  submenuItem: {
    ...
    "&:hover": {
      backgroundColor: "rgba(237, 52, 52, 0.7)",
    },
  },
  ...
  return (
    <Box className={classes.root}>
      ...
      >
        ...
        <Box
          className={classes.sidebarItem}
          onClick={() => !collapsed && toggleMenu("products")}
        ...
        >
          ...
          {!collapsed &&
            (expandedMenus.products ? <ExpandLessIcon /> : <ExpandMoreIcon />)}
        </Box>

        {!collapsed && expandedMenus.products && (
          <>
            <Box
        ...
        <Box
          className={classes.sidebarItem}
          onClick={() => !collapsed && toggleMenu("shipping")}
          sx={{ justifyContent: "space-between" }}
        >
          <Box display="flex" alignItems="center" gap={1.5}>
            <LocalShippingIcon />
          ...
          {!collapsed &&
            (expandedMenus.shipping ? <ExpandLessIcon /> : <ExpandMoreIcon />)}
        </Box>

        {!collapsed && expandedMenus.shipping && (
          <>
            <Box
              className={`${classes.submenuItem} ${
                isActive("/shipments") ? classes.activeItem : ""
              }`}
              onClick={() => handleNavigate("/shipments")}
            >
        ...
        <Box
          className={`${classes.sidebarItem} ${
            isActive("/quotes") ? classes.activeItem : ""
          }`}
        ...
        <Box
          className={`${classes.sidebarItem} ${
            isActive("/gallery") ? classes.activeItem : ""
          }`}
        ...
        <Box
          className={`${classes.sidebarItem} ${
            isActive("/Replacement") ? classes.activeItem : ""
          }`}
        ...
        <Box
          className={`${classes.sidebarItem} ${
            isActive("/visits-trips") ? classes.activeItem : ""
          }`}
          onClick={() => handleNavigate("/visits-trips")}
        >
          <AutorenewIcon />
